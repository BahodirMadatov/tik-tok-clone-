    ...
    >
      ...
      <div class="mt-8 md:flex gap-6">
        <label
          ...
          @drop.prevent="onDrop"
          @dragover.prevent=""
          class="md:mx-0 mx-auto mt-4 mb-6 flex flex-col items-center justify-center w-full max-w-[260px] h-[470px] text-center p-3 border-2 border-dashed border-gray-300 rounded-lg hover:bg-gray-100 coursor-pointer"
        >
        ...
        <div class="mt-4 mb-5">
          <div class="flex bg-[#F8F8F8] py-4 px-6">
            ...
            <div>
              <div class="text-semibold text-[15px] mb-1.5">Devide video</div>
