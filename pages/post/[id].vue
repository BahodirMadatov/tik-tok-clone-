    ...
    >
        ...
        >
            ...
            <div class="flex items-center px-8 mt-8">
                ...
                <div class="pb-4 text-center flex items-center">
                    <div class="rounded-full bg-gray-200 p-2 cursor-pointersor-">
                    ...
                    <div class="flex items-center relative w-full">
                        ...
                        <div class="ml-14 pt-0.5 w-full">
                            ...
                            <div class="text-[15px] font-light">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Non ex magni, earum et voluptatum id vero. Veritatis ab quam, qui corrupti dolore corporis velit nihil.
                            </div>
                        </div>
                    </div>
                </div>
