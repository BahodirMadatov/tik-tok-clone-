<template>
  <div id="PostMain" class="flex border-b py-6">
    <div class="coursor-pointer">
      <img class="rounded-full max-h-[60px]" width="60" src="https://picsum.photos/id/8/300/320" alt="">
    </div>
    <div class="pl-3 w-full px-4">
      <div class="flex items-center justify-between pb-0.5">
        ...
        <button class="border text-[15px] px-[21px] py-0.5 border-[#F02C56] text-[#F02C56] hover:bg-[#ffeef2] font-semibold rounded-nd">
          Follow
        </button>
      </div>
      ...
      <div class="text-[14px] text-gray-500 pb-0.5">#fun #cool #Super</div>

      <div class="text-[14px] pb-0.5 flex items-center font-semibold">
        <Icon name="mdi:music" size="17"/>
        <p class="px-1">original sound -AWESOME</p>
        <Icon name="mdi:heart" size="20"/>
      </div>

      <div class="mt-2.5 flex">
        <div class="relative min-h-[480px] amx-h-[580px] max-w-[260px] flex items-center bg-black rounded-xl cursor-pointer">
          <video 
            ref="video"
            loop
            muted
