<template>
  ...
  >
    <div
      class="lg:w-full w-[55px] mx-auto"
    >
      <NuxtLink to="/">
        <MenuItem iconString="For you" colorString="#F02C56" sizeString="30"/>
      </NuxtLink>
      <MenuItem iconString="Following" colorString="#00000" sizeString="27"/>
      <MenuItem iconString="LIVE" colorString="#00000" sizeString="27"/>
      ...
      <div class="lg:block hidden text-[11px] text-gray-500">
        <div class="pt-4 px-2">About Newsroom Contact Careers</div>
        <div class="pt-4 px-2">TikTok for Good Advertise Developers Transparency TikTok Rewards TikTok Embeds</div>
